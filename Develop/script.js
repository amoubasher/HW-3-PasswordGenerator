...
function generatePassword () {
  var passwordLength = prompt("How many characters do you want your password to be? (8-12)", "12");
  ...
  // Make a structure for potential characters from arrys of characters
  var potentialChars = [];
  if (useUpperCase) {
